...
+ (NSArray *)itineraryForTrip:(NSString *)tripName
{
    ...
    NSDictionary *dict1 = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           @"Depart Detroit on overrnight flight to Germany", nil];
    ...
    NSDictionary *dict2 = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           @"Arrive in Frankfurt and transfer to Straelen", nil];
    ...
    NSDictionary *dict3 = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           @"A sightseeing stop in the beautiful town of Rudesheim", nil];
    ...
    NSDictionary *dict4 = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           @"Check into the Straelenerhof Hotel", nil];
    ...
    NSDictionary *dict5 = [NSDictionary dictionaryWithObjectsAndKeys:
                           ...
                           @"Practice at SV Straelen - 800 yards from hotel", nil];
    ...
    NSDictionary *dict25 = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            @"Visit to WW1/WW2 German bunkers and Ostend", nil];
    ...
    NSDictionary *dict26 = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            @"", EVENT_TIME
                            @"Game", EVENT_TITLE
                            @"Soccer Game - TFA vs KV Oostend", nil];
    ...
    NSDictionary *dict35 = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            @"Full day sightseeing in London", nil];
    ...
    NSDictionary *dict42 = [NSDictionary dictionaryWithObjectsAndKeys:
                            ...
                            @"Depart London Heathrow for flight to Detroit", nil];
