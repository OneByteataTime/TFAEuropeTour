...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    JTCFirstViewController *topView = (JTCFirstViewController *)[controller.viewControllers objectAtIndex:0];
    topView.dataController.managedObjectContext = self.managedObjectContext;
    return YES;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"TFAEuropeTourModel" withExtension:@"momd"];
